    ...
    <div className="relative w-full h-screen flex flex-col items-center">
      ...
      <div className="w-full max-w-3xl mb-[20vh]">
        ...
        <div className="flex items-center justify-center flex-wrap gap-3 mt-6">
          ...
          <QuickAction icon={<Lightbulb className="w-4 h-4" />} label="Create Business Idea" />
          <QuickAction icon={<Globe className="w-4 h-4" />} label="Build a Website" />
          <QuickAction icon={<Users className="w-4 h-4" />} label="LITHOVEX Co-work" />
