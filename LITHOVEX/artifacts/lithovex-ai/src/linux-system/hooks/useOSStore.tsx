...
import type { OSState, OSAction, Window, DesktopIcon, Notification, DockItem, WindowState } from '@linux/types';
import { APP_REGISTRY, getAppById, getDefaultDockApps } from '@linux/apps/registry';
