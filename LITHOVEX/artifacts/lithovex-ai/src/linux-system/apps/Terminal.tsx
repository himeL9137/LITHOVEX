...
import { useFileSystem } from '@linux/hooks/useFileSystem';
...
const COMMANDS: Record<string, (args: string[], ctx: TerminalContext) => string | string[]> = {
  ...
  uname: () => 'LITHOVEX OS 1.0.0-generic x86_64',
  ...
  neofetch: () => [
    ...
    '',
    '\x1b[36mOS:\x1b[0m LITHOVEX OS 1.0.0',
    '\x1b[36mKernel:\x1b[0m browser-engine-20.0',
    '\x1b[36mShell:\x1b[0m lithovex-shell 1.0',
    '\x1b[36mDE:\x1b[0m GNOME-like Web Desktop',
    '\x1b[36mTheme:\x1b[0m Adwaita-dark [GTK2/3]',
    '\x1b[36mIcons:\x1b[0m Lithovex-mono-dark [GTK2/3]',
    '\x1b[36mTerminal:\x1b[0m lithovex-terminal',
...
export default function Terminal() {
  ...
  const [lines, setLines] = useState<TerminalLine[]>([
    { type: 'system', text: 'Welcome to LITHOVEX OS Terminal' },
