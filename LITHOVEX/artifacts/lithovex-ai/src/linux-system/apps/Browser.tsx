...
const NEWS_ARTICLES = [
  { title: 'LITHOVEX OS 1.0 Released with New Features', source: 'lithovex.dev', time: '2h ago' },
...
// ---- Simulated pages ----
const IFRAME_FRIENDLY_SITES = ['example.com', 'wikipedia.org', 'lithovex.dev'];
...
const generateSimulatedPage = (url: string): string => {
  ...
  return `
    ...
    <body>
      <div class="header">
        <h1>${host}</h1>
        <p>Simulated page for LITHOVEX Browser</p>
      </div>
      <div class="content">
        <h2>Welcome to ${host}</h2>
        <p>This is a simulated version of the website running inside LITHOVEX Browser. Many real websites block iframe embedding for security reasons.</p>
  ...
  return (
    <div className="h-full flex flex-col items-center justify-start pt-12 custom-scrollbar overflow-auto" style={{ background: 'var(--bg-window)' }}>
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 style={{ fontSize: '28px', fontWeight: 700, color: 'var(--text-primary)' }}>LITHOVEX Browser</h1>
      </div>
