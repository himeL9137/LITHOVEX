...
const BOT_RESPONSES: Record<string, string> = {
  ...
  hi: 'Hi! I\'m your LITHOVEX Assistant. What can I do for you?',
...
const createInitialConversations = (): Conversation[] => [
  {
    ...
    messages: [
      { id: '1', senderId: 'bot', content: 'Hello! I\'m your LITHOVEX Assistant. I can help you with various tasks. Try asking me about the time, weather, or just say hello!', timestamp: Date.now() - 3600000, type: 'text' },
    ],
  },
  {
