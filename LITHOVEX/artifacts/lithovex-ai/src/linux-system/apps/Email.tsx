...
const INITIAL_EMAILS: Email[] = [
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Meeting notes from today',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Security alert for your repository',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Project update - Phase 2 complete',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Your weekly tech digest',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Lunch next week?',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Your order has shipped!',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Code review feedback',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'New releases this month',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Happy New Year!',
  ...
  {
    id: '11', from: 'Security Team', fromEmail: 'security@lithovex.local',
    to: ['user@lithovex.local'], subject: 'Important: Password reset required',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'You won a prize!',
  ...
  {
    id: '13', from: 'me', fromEmail: 'user@lithovex.local',
  ...
  {
    id: '14', from: 'me', fromEmail: 'user@lithovex.local',
  ...
  {
    id: '15', from: 'me', fromEmail: 'user@lithovex.local',
  ...
  },
  {
    ...
    to: ['user@lithovex.local'], subject: 'Last month\'s deals',
...
const ComposeModal = memo(function ComposeModal({ onClose, onSend }: { onClose: () => void; onSend: (email: Omit<Email, 'id' | 'date' | 'isRead' | 'isStarred' | 'labels'>) => void }) {
  ...
  const handleSend = () => {
    ...
    onSend({ from: 'me', fromEmail: 'user@lithovex.local', to: [to], subject, body, folder: 'sent' });
    onClose();
  };
